...
export default function App() {
    ...
    return (
        <>
            <Navbar collapseOnSelect fixed="top" expand="md" variant="dark" style={{backgroundColor:"rgba(112,112,112,0.05)",zIndex:"100"}}>
            ...
            <div className="bg-light" style={{position:"relative",height:"0",overflow:"hidden",paddingBottom:"56.25%"}}>
                <iframe style={{position:"absolute",top:"0",left:"0",width:"100%",height:"100%"}} src="https://www.youtube.com/embed/rTtSwHkpRC8?autoplay=1&mute=1"
